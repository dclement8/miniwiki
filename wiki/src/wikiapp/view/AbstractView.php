...
abstract class AbstractView {
    ...
    */
    public function __construct($data){
        ...
        $http = new \wikiapp\utils\HttpRequest();
    ...
    protected function renderMenu(){
        $html  = '<h2>Menu</h2>';
        $html .= '<ul>';
        $html .= '<li><a href="'.$this->script_name.'/wiki/all/">Tous les articles</a></li>';
        if(!isset($_SESSION['user_login'])) {
            ...
            $html .= '<li><a href="'.$this->script_name.'/admin/logout/">Déonnexion</a></li>';
        }
        $html .= "</ul>";
        return $html;
